const SITE_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: `As a Media Planner at dentsu (Carat), I supported the media strategy for the launch of KD Frozen (2024), bringing the iconic Kraft Dinner brand into the frozen aisle for the first time. The ready-to-heat frozen mac and cheese entr\u00E9es were introduced across Canadian grocery retailers including Sobeys, FreshCo, and Safeway. The media plan drove awareness of the new product format through digital advertising, in-store activations, and social content, positioning KD Frozen as a convenient, premium option for consumers seeking the classic KD taste in a quick, heat-and-eat format.`
    },
    {
    ...
    {
      title: "KD \u2014 \u201CSpoon KD\u201D",
      externalLink: "https://strategyonline.ca/2023/03/06/kd-creates-a-new-box-for-people-who-eat-it-with-a-spoon/",
      tags: ["Media Planning", "Kraft Heinz"],
      description: `As a Media Planner at dentsu (Carat), I contributed to the media strategy for KD's "Spoon KD" campaign (2023). In a playful nod to the timeless fork vs. spoon debate, KD launched "Spoon KD" \u2014 positioning the spoon as the definitive utensil for eating Kraft Dinner. After over 50 years with a fork on the box, the campaign introduced the spoon front and center, sparking conversation and engagement across social media, digital placements, and in-store activations.`
    },
    {
      title: "Kraft Hockeyville",
      thumbnailUrl: "https://img.youtube.com/vi/Rf-aH6Cel64/hqdefault.jpg",
      tags: ["Media Planning", "Kraft Heinz"],
      description: `As a Media Planner at dentsu (Carat), I supported the national media plan for Kraft Hockeyville 2024, Kraft Heinz's iconic annual competition celebrating the role of local hockey arenas in Canadian communities. Partnering with the NHL and NHLPA, the campaign invited communities across Canada to nominate their arena for a chance to win $250,000 in upgrades and an NHL pre-season game. Elliot Lake, Ontario was crowned the 2024 winner. The fully integrated media plan included linear TV integrations during hockey programming, high-impact digital placements, social media outreach, and national OOH to drive nominations and community voting.`
    },
    {
      title: "Heinz Ketchup \u2014 \u201CSmack For Heinz\u201D",
      videoId: "UTPchTpqNHU",
      tags: ["Media Planning", "Kraft Heinz"],
      description: `As a Media Planner at dentsu (Carat), I supported the media strategy for the "Smack For Heinz" campaign (2024). This interactive OOH activation placed ketchup-dispensing billboards outside famous Chicago hot dog stands and restaurants known for not serving Heinz. Fans could "smack" the billboard to receive a free Heinz ketchup packet, turning the classic physical act of tapping a bottle into a digital-physical experience. The campaign generated 366 million earned impressions, helped drive $8.4 million in new restaurant business, and outperformed social benchmarks by 157%.`,
      awards: [
    ...
    },
    {
      ...
      emoji: "\u26A1",
      tags: ["Media Planning", "Kraft Heinz"],
      description: `As a Media Planner at dentsu (Carat), I contributed to the media strategy for MiO Energy's influencer-driven campaign (2023\u20132024). The campaign leveraged creators on TikTok and Instagram to promote MiO Energy's product line to a younger, digitally-native audience. Key activations included the "Another Busy Morning" influencer series and "Squeeze" productivity content, focusing on themes of staying hydrated and energized. The media plan targeted high-impact digital placements and social-first content partnerships to drive awareness around MiO's rebranded energy line.`
    },
    {
      title: "Kraft Peanut Butter \u2014 \u201CWelcome Home Jars\u201D",
      thumbnailUrl: "https://img.youtube.com/vi/o-n_GmEu4OA/hqdefault.jpg",
      tags: ["Media Planning", "Kraft Heinz"],
      description: `As a Media Planner at dentsu (Carat), I supported the media strategy for Kraft Peanut Butter's "Welcome Home Jars" campaign (2023), an initiative welcoming newcomers to Canada. Partnering with Duolingo and featuring Nav Bhatia, the campaign replaced jar labels with welcome messages in five languages and included custom language resources and real-time interactive airport billboards. All limited-edition jars were claimed within hours of launch. The integrated media plan spanned contextually relevant OOH placements, social, and digital channels.`,
      awards: [
